...
while True:
    ...
    while game == False:  # Tant que la partie n'est pas lancée :
        ...
        print(
            "1." + Style.BRIGHT + " Lancer le jeu en solo" + Style.RESET_ALL + "\n2." + Style.BRIGHT + " Paramètres du jeu" + Style.RESET_ALL + "\n3." + Style.BRIGHT + " Joueur contres joueurs")
        choix_debut = input(
            "Saisissez votre choix : ")  # Recupère le choix de l'utilisateur sur le lancement de la partie
    ...
    while game:
        ...
        if isinstance(joueur,
                      perso.Sorcier):  # si le personnage choisi est un sorcier, on lui propose aussi de se soigner
